package io.heapy.argo.client.infrastructure
...
import io.heapy.argo.client.auth.*
...
open class ApiClient(
    ...
    private val authentications: kotlin.collections.Map<String, Authentication> by lazy {
        mapOf(
                "BearerToken" to ApiKeyAuth("header", "Authorization"))
    }

    companion object {
          const val BASE_URL: String = "http://localhost:2746"
