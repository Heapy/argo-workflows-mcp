...
import io.heapy.argo.client.models.WorkflowEventBindingList
...
import io.ktor.http.ParametersBuilder
    ...
    httpClientConfig: ((HttpClientConfig<*>) -> Unit)? = null,
        ...
        */
        ...
        open suspend fun eventServiceListWorkflowEventBindings(namespace: kotlin.String, listOptionsLabelSelector: kotlin.String?, listOptionsFieldSelector: kotlin.String?, listOptionsWatch: kotlin.Boolean?, listOptionsAllowWatchBookmarks: kotlin.Boolean?, listOptionsResourceVersion: kotlin.String?, listOptionsResourceVersionMatch: kotlin.String?, listOptionsTimeoutSeconds: kotlin.String?, listOptionsLimit: kotlin.String?, listOptionsContinue: kotlin.String?, listOptionsSendInitialEvents: kotlin.Boolean?): HttpResponse<WorkflowEventBindingList> {
            ...
            RequestMethod.GET,
            "/api/v1/workflow-event-bindings/{namespace}".replace("{" + "namespace" + "}", "$namespace"),
        ...
        * 
        * 
         * @param namespace The namespace for the  This can be empty if the client has cluster scoped permissions. If empty, then the event is \&quot;broadcast\&quot; to workflow event binding in all namespaces. 
        ...
        */
            @Suppress("UNCHECKED_CAST")
        open suspend fun eventServiceReceiveEvent(namespace: kotlin.String, discriminator: kotlin.String, body: kotlin.Any): HttpResponse<kotlin.Any> {
            ...
            val localVariableConfig = RequestConfig<kotlin.Any?>(
            RequestMethod.POST,
            "/api/v1/events/{namespace}/{discriminator}".replace("{" + "namespace" + "}", "$namespace").replace("{" + "discriminator" + "}", "$discriminator"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            requiresAuthentication = true,
            )
