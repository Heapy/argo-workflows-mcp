...
import io.heapy.argo.client.models.KubernetesSysctl
 ...
 * @param fsGroup A special supplemental group that applies to all containers in a pod. Some volume types allow the Kubelet to change the ownership of that volume to be owned by the pod:  1. The owning GID will be the FSGroup 2. The setgid bit is set (new files created in the volume will be owned by FSGroup) 3. The permission bits are OR'd with rw-rw----  If unset, the Kubelet will not modify the ownership and permissions of any volume. Note that this field cannot be set when spec.os.name is windows.
...
data class KubernetesPodSecurityContext (
    ...
    @SerialName(value = "seLinuxChangePolicy")
    val seLinuxChangePolicy: kotlin.String? = null,
    ...
    @SerialName(value = "supplementalGroups")
    val supplementalGroups: kotlin.collections.List<kotlin.Long>? = null,

    /* Defines how supplemental groups of the first container processes are calculated. Valid values are \"Merge\" and \"Strict\". If not specified, \"Merge\" is used. (Alpha) Using the field requires the SupplementalGroupsPolicy feature gate to be enabled and the container runtime must implement support for this feature. Note that this field cannot be set when spec.os.name is windows. */
    @SerialName(value = "supplementalGroupsPolicy")
    val supplementalGroupsPolicy: kotlin.String? = null,

    /* Sysctls hold a list of namespaced sysctls used for the pod. Pods with unsupported sysctls (by the container runtime) might fail to launch. Note that this field cannot be set when spec.os.name is windows. */
    @SerialName(value = "sysctls")
    val sysctls: kotlin.collections.List<KubernetesSysctl>? = null,
